...
from ...models.body_verify_verify_v1_auth_verify_post import BodyVerifyVerifyV1AuthVerifyPost
...
def _get_kwargs(
    *,
    client: Client,
    json_body: BodyVerifyVerifyV1AuthVerifyPost,
) -> Dict[str, Any]:
    url = "{}/v1/auth/verify".format(client.base_url)
